...
func (uu *UserUpdate) SetDiscordID(u uint64) *UserUpdate {
	uu.mutation.ResetDiscordID()
	uu.mutation.SetDiscordID(u)
	return uu
}

// AddDiscordID adds u to DiscordID.
func (uu *UserUpdate) AddDiscordID(u uint64) *UserUpdate {
	uu.mutation.AddDiscordID(u)
	return uu
}
...
func (uu *UserUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := uu.mutation.AddedDiscordID(); ok {
...
// SetDiscordID sets the DiscordID field.
func (uuo *UserUpdateOne) SetDiscordID(u uint64) *UserUpdateOne {
	uuo.mutation.ResetDiscordID()
	uuo.mutation.SetDiscordID(u)
	return uuo
}

// AddDiscordID adds u to DiscordID.
func (uuo *UserUpdateOne) AddDiscordID(u uint64) *UserUpdateOne {
	uuo.mutation.AddDiscordID(u)
	return uuo
}
...
func (uuo *UserUpdateOne) sqlSave(ctx context.Context) (_node *User, err error) {
	...
	if value, ok := uuo.mutation.AddedDiscordID(); ok {
		_spec.Fields.Add = append(_spec.Fields.Add, &sqlgraph.FieldSpec{
			Type:   field.TypeUint64,
			Value:  value,
			Column: user.FieldDiscordID,
